# Generated by Powerlevel10k configuration wizard on 2023-11-27 at 19:09 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, slanted separators, round heads, sharp tails, 2 lines, solid, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%F{238}╰%F{044}\uE0B2%K{044}%F{black}  %f%F{044}%k%f "
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT="%D{%a,%l:%M %p}"
  ...
  source ~/.config/zsh/powerlevel2k.zsh
